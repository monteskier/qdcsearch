...
export const useGetQDC = ()=>{
  ...
  const getSeccio = async()=>{
    try {
      const response = await fetch('/qdcsearch/assets/dades/seccio.csv');
  ...
  const getSubSeccio = async()=>{
    try {
      const response = await fetch('/qdcsearch/assets/dades/subseccio.csv');
      const csvData = await response.text();
  ...
  const getSubSerie = async()=>{
    try {
      const response = await fetch('/qdcsearch/assets/dades/subserie.csv');
      const csvData = await response.text();
  ...
  const getSerie = async()=>{
   try {
      const response = await fetch('/qdcsearch/assets/dades/serie.csv');
      const csvData = await response.text();
